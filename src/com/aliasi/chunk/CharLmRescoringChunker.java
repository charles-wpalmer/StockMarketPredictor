 ...
 * {@link com.aliasi.corpus.TagHandler} interface, allowing training through BIO-encoded
...
public class CharLmRescoringChunker
    extends AbstractCharLmRescoringChunker<CharLmHmmChunker, // PLEASE IGNORE DEPRECATION WARNING
                                           NGramProcessLM,
                                           NGramBoundaryLM>
    implements com.aliasi.corpus.TagHandler,  // PLEASE IGNORE DEPRECATION WARNING
     ...
     * @deprecated Use {@link #handle(Chunking)} instead.
     */
    @Deprecated
    public void handle(String[] toks, String[] whitespaces, String[] tags) {
        com.aliasi.corpus.TagHandler handler = new ChunkTagHandlerAdapter2(this);
