...
public class Collections {
     ...
     * @param <E> type of objects in the list
     * @deprecated Use {@code set.iterator().next()} instead.
     */
    @Deprecated
    ...
    */
     ...
     * @deprecated Implement directly using {@link Number#intValue()}.
     */
    @Deprecated
     ...
     * @deprecated Use {@code Set.toString()} instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@code List.toString()} instead.
     */
    @Deprecated
