...
public class TrainSpellChecker 
    implements com.aliasi.corpus.TextHandler, // PLEASE IGNORE DEPRECATION WARNING
     ...
     * com.aliasi.corpus.TextHandler} interface.  Otherwise, it behaves exactly the same
    ...
    public void handle(char[] cs, int start, int length) {
        handle(new String(cs,start,length));
    }
