...
public class MarginalTaggerEvaluator<E> implements ObjectHandler<Tagging<E>> {
    ...
    private final Object mEvaluator;
    ...
    public MarginalTaggerEvaluator(MarginalTagger<E> tagger,
        ...
        mEvaluator = createEvaluator(tags,storeTokens);
    ...
    Object createEvaluator(String[] tags, boolean storeTokens) {
        @SuppressWarnings("deprecation")
        Object evaluator
            = new com.aliasi.classify.ClassifierEvaluator<E,ConditionalClassification>(null,tags,storeTokens);
        return evaluator;
    }
    ...
    public void addCase(Tagging<E> referenceTagging,
        ...
        for (int n = 0; n < tokens.size(); ++n) {
            ...
            evaluatorAddClassification(referenceTag,responseClassification,token);
     ...
     */
    @SuppressWarnings("deprecation") @Deprecated
    void evaluatorAddClassification(String referenceTag,
                                    ConditionalClassification responseClassification,
                                    E token) {
        @SuppressWarnings({"unchecked","deprecation"})
        com.aliasi.classify.ClassifierEvaluator<E,ConditionalClassification> evaluator
            = (com.aliasi.classify.ClassifierEvaluator<E,ConditionalClassification>) mEvaluator;
        evaluator.addClassification(referenceTag,responseClassification,token);
    }
     ...
     * @deprecated Use {@link #perTokenEval()} instead.
     */
    @SuppressWarnings("deprecation") @Deprecated
    public com.aliasi.classify.ClassifierEvaluator<E,ConditionalClassification> perTokenEvaluation() {
        @SuppressWarnings({"unchecked","deprecation"})
        com.aliasi.classify.ClassifierEvaluator<E,ConditionalClassification> result
            = (com.aliasi.classify.ClassifierEvaluator<E,ConditionalClassification>) mEvaluator;
        return result;
    }
