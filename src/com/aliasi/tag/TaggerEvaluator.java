...
public class TaggerEvaluator<E> implements ObjectHandler<Tagging<E>> {
     ...
     * being stored.
     * @deprecated Use {@link #unknownTokenEval(Set)} instead.
     */
    @Deprecated
    public com.aliasi.classify.ClassifierEvaluator<E,Classification> unknownTokenEvaluation(Set<E> knownTokenSet) {
        if (!storeTokens()) {
            String msg = "Must store inputs to compute unknown token accuracy.";
            throw new UnsupportedOperationException(msg);
        }
        return evaluation(knownTokenSet);
    }
     ...
     * @deprecated Use {@link #tokenEval()} instead.
     */
    @Deprecated
    public com.aliasi.classify.ClassifierEvaluator<E,Classification> tokenEvaluation() {
     ...
     */
    @Deprecated
    com.aliasi.classify.ClassifierEvaluator<E,Classification> evaluation(Set<E> knownTokenSet) {
        String[] tags = tags().toArray(Strings.EMPTY_STRING_ARRAY);
        com.aliasi.classify.ClassifierEvaluator<E,Classification> evaluator
            = new com.aliasi.classify.ClassifierEvaluator<E,Classification>(null,tags,storeTokens());
        for (int i = 0; i < mReferenceTagss.size(); ++i) {
