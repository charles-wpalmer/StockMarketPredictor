 ...
 * @deprecated Use {@link com.aliasi.corpus.XValidatingObjectCorpus} with type {@code
 * com.aliasi.corpus.ObjectHandler<Classified<E>>} instead.
 */
@SuppressWarnings("deprecation") @Deprecated
public class XValidatingClassificationCorpus<E>
    extends Corpus<com.aliasi.corpus.ClassificationHandler<E,Classification>>
    implements com.aliasi.corpus.ClassificationHandler<E,Classification> {
     ...
     */
    @SuppressWarnings("deprecation") @Deprecated
    public XValidatingClassificationCorpus(Parser<com.aliasi.corpus.ClassificationHandler<E,Classification>> parser,
                                           File[] dataFiles,
    ...
    public void visitTest(com.aliasi.corpus.ClassificationHandler<E,Classification> handler) {
     ...
     */
    @SuppressWarnings("deprecation") @Deprecated @Override
    public void visitTrain(com.aliasi.corpus.ClassificationHandler<E,Classification> handler) {
    ...
    /**
     * @deprecated  Req for suppressing warning.
     */
    @SuppressWarnings("deprecation") @Deprecated
    private void handle(com.aliasi.corpus.ClassificationHandler<E,Classification> handler, int start, int end) {
