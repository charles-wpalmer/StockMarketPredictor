 ...
 * cases are then added using the {@link #handle(Classified)} which
 * accepts a string-based category and object to classify.  The
 ...
 * @deprecated Use {@link BaseClassifierEvaluator} or one of its subclasses.
 */
@Deprecated
public class ClassifierEvaluator<E,C extends Classification>
    implements com.aliasi.corpus.ClassificationHandler<E,Classification>, // PLEASE IGNORE DEPRECATION WARNING
     ...
     */
    @Deprecated
    public ClassifierEvaluator(Classifier<E,? extends C> classifier,
                               String[] categories,
                               boolean storeInputs) {
    ...
    /**
     * Handle the specified classified object as a test instance with
     * a reference classification as specified.  A response classification
     * is produced by the contaied classifier.  The reference and
     * response classifications are then added to the evaluation.
     *
     * @param c Classified object.
     */
    public void handle(Classified<E> c) {
        handle(c.getObject(),c.getClassification());
    }
