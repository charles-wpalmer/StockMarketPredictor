...
public class LogisticRegressionClassifier<E>
    implements Classifier<E,ConditionalClassification>,  // PLEASE IGNORE DEPRECATION WARNING
    ...
    public static <F> LogisticRegressionClassifier<F>
        train(FeatureExtractor<? super F> featureExtractor,
              Corpus<com.aliasi.corpus.ClassificationHandler<F,Classification>> corpus,
              int minFeatureCount,
              boolean addInterceptFeature,
     ...
     * reading the data from the corpus.
     * @param <F> the type of object to be classified
     * @deprecated Use {@link #train(Corpus,FeatureExtractor,int,boolean,RegressionPrior,AnnealingSchedule,double,int,int,Reporter)} instead.
     */
    ...
    public static <F> LogisticRegressionClassifier<F>
        ...
        Corpus<ObjectHandler<Classified<F>>> corpus2 
            = new ClassificationHandlerCorpusAdapter2<F>(corpus);

        return train(corpus2,
                     featureExtractor,
                     minFeatureCount,
                     addInterceptFeature,
                     prior,
