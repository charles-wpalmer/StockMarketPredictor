...
public class PerceptronClassifier<E>
    implements Classifier<E,ScoredClassification>,  // PLEASE IGNORE DEPRECATION WARNING
               ScoredClassifier<E>,
               Serializable {
     ...
     * @deprecated Use constructor {@link #PerceptronClassifier(Corpus,FeatureExtractor,KernelFunction,String,int,String,String)} instead.
     */
    ...
    public PerceptronClassifier(com.aliasi.util.FeatureExtractor<? super E> featureExtractor,
                                KernelFunction kernelFunction,
                                Corpus<com.aliasi.corpus.ClassificationHandler<E,Classification>> corpus,
    ...
    public PerceptronClassifier(FeatureExtractor<? super E> featureExtractor,
        ...
        this(new ClassificationHandlerCorpusAdapter2<E>(corpus),
             featureExtractor,
             kernelFunction,
             corpusAcceptCategory,
             numIterations,
             outputAcceptCategory,
             outputRejectCategory);
    }
