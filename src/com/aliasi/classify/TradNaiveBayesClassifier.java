...
public class TradNaiveBayesClassifier
    implements com.aliasi.corpus.ClassificationHandler<CharSequence,Classification>, // PLEASE IGNORE DEPRECATION WARNING
               Classifier<CharSequence,JointClassification>,  // PLEASE IGNORE DEPRECATION WARNING
     ...
     * @deprecated Use {@link #handle(Classified)} instead.
     */
    @Deprecated
     ...
     * classifier.
     * @deprecated Use {@link #emIterator(TradNaiveBayesClassifier,Factory,Corpus,Corpus,double)} instead.
     */
    ...
    public static Iterator<TradNaiveBayesClassifier>
        em(TradNaiveBayesClassifier initialClassifier,
           ...
           Corpus<com.aliasi.corpus.ClassificationHandler<CharSequence,Classification>> labeledData,
           Corpus<com.aliasi.corpus.TextHandler> unlabeledData,
           double minTokenCount) throws IOException {

        return new EmIterator(initialClassifier,classifierFactory,
                              new ClassificationHandlerCorpusAdapter2<CharSequence>(labeledData),
                              new TextHandlerCorpusAdapter2(unlabeledData),
                              minTokenCount);
    }
     ...
     * @deprecated Use {@link #emTrain(TradNaiveBayesClassifier,Factory,Corpus,Corpus,double,int,double,Reporter)} instead.
     */
    @SuppressWarnings("deprecation") @Deprecated
    public static TradNaiveBayesClassifier
        ...
        return emTrain(initialClassifier,
                       classifierFactory,
                       new ClassificationHandlerCorpusAdapter2<CharSequence>(labeledData),
                       new TextHandlerCorpusAdapter2(unlabeledData),
                       minTokenCount,
    ...
    private static class CompiledBinaryTradNaiveBayesClassifier
        implements Classifier<CharSequence,JointClassification>, // PLEASE IGNORE DEPRECATION WARNING
                   JointClassifier<CharSequence> {
        private final TokenizerFactory mTokenizerFactory;
    ...
    static class TextHandlerCorpusAdapter2
         ...
         */
        @SuppressWarnings("deprecation") @Deprecated
        public TextHandlerCorpusAdapter2(Corpus<com.aliasi.corpus.TextHandler> corpus) {
            mCorpus = corpus;
        }
