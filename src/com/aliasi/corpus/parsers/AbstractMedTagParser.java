...
*/
@Deprecated
public abstract class AbstractMedTagParser extends StringParser<com.aliasi.corpus.TagHandler> {
    ...
    public AbstractMedTagParser(com.aliasi.corpus.TagHandler handler) {
        super(handler);
    }
