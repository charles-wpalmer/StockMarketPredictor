...
public class Reuters21578Parser
    extends StringParser<com.aliasi.corpus.ClassificationHandler<CharSequence,Classification>> {
     ...
     */
    @SuppressWarnings("deprecation") @Deprecated
    public static Corpus<com.aliasi.corpus.ClassificationHandler<CharSequence,Classification>>
    ...
    private static class ReutersCorpus
        extends Corpus<com.aliasi.corpus.ClassificationHandler<CharSequence,Classification>> {
        ...
        public void visitCorpus(com.aliasi.corpus.ClassificationHandler<CharSequence,Classification> handler)
            throws IOException {
         ...
         */
        @SuppressWarnings("deprecation") @Deprecated @Override
        public void visitTest(com.aliasi.corpus.ClassificationHandler<CharSequence,Classification> handler)
            throws IOException {
         ...
         */
        @SuppressWarnings("deprecation") @Deprecated @Override
        public void visitTrain(com.aliasi.corpus.ClassificationHandler<CharSequence,Classification> handler)
            throws IOException {
         ...
         */
        @SuppressWarnings("deprecation") @Deprecated
        void visit(com.aliasi.corpus.ClassificationHandler<CharSequence,Classification> handler,
