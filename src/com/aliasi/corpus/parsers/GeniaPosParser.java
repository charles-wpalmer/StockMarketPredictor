...
public class GeniaPosParser extends StringParser<com.aliasi.corpus.TagHandler> {
     ...
     */
    @Deprecated
    public GeniaPosParser(com.aliasi.corpus.TagHandler handler) {
        super(handler);
    }
     ...
     * {@link com.aliasi.corpus.TagHandler} was set using {@link #setHandler(Handler)}.
     * @deprecated Use generic {@link #getHandler()} instead.
     */
    @Deprecated
    public com.aliasi.corpus.TagHandler getTagHandler() {
        return getHandler();
    }
    ...
    public void parseString(char[] cs, int start, int end) {
        com.aliasi.corpus.TagHandler handler = getTagHandler();
     ...
     */
    @Deprecated
    private static void handle(com.aliasi.corpus.TagHandler handler, 
                               List<String> tokList, List<String> tagList) {
