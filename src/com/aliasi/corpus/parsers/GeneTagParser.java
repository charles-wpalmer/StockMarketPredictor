...
public class GeneTagParser extends AbstractMedTagParser {
     ...
     */
    @Deprecated
    public GeneTagParser(com.aliasi.corpus.TagHandler handler) {
        super(handler);
    }
    ...
    public static final String B_GENE_TAG
        = com.aliasi.corpus.ChunkTagHandlerAdapter.toBeginTag(GENE_TYPE);
    ...
    public static final String I_GENE_TAG
        = com.aliasi.corpus.ChunkTagHandlerAdapter.toInTag(GENE_TYPE);
    ...
    static String[] normalize(String[] tags) {
        ...
        for (int i = 0; i < tags.length; ) {
            if (tags[i].startsWith("GENE")) {
                ...
                result[i++] = com.aliasi.corpus.ChunkTagHandlerAdapter.OUT_TAG;
            }
        }
        return result;
    }
