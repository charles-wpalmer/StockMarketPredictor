 ...
 */
@SuppressWarnings("deprecated") @Deprecated
public class BrownPosParser extends StringParser<com.aliasi.corpus.TagHandler> {
     ...
     */
    @Deprecated
    public BrownPosParser(com.aliasi.corpus.TagHandler handler) {
        super(handler);
    }
     ...
     */
    @Deprecated
    public com.aliasi.corpus.TagHandler tagHandler() {
        return getHandler();
    }
