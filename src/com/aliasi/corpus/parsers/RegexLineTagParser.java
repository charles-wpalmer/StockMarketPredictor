 ...
 * @version 3.8
 * @since   LingPipe2.4.0
 * @deprecated Use {@link com.aliasi.tag.LineTaggingParser} instead.
 */
@Deprecated
public class RegexLineTagParser extends StringParser<com.aliasi.corpus.TagHandler> {
     ...
     */
    @Deprecated
    public RegexLineTagParser(com.aliasi.corpus.TagHandler handler,
