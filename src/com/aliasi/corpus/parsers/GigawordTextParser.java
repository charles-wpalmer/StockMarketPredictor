 ...
 */
@Deprecated
public class GigawordTextParser extends StringParser<com.aliasi.corpus.TextHandler> {
     ...
     */
    @Deprecated
    public GigawordTextParser(com.aliasi.corpus.TextHandler handler) {
        super(handler);
    }
    ...
    public void parseString(char[] cs, int start, int end) throws IOException {
        ...
        com.aliasi.corpus.TextHandler handler = getHandler();
