...
/**
 * A {@code ClassificationHandlerCorpusAdapter} adapts a corpus
 * accepting a classification handler to a corpus accepting
 * a classified object handler.
 *
 * <p><i>Do not use</i>:  This class is merely a convenience
 * supporting refactoring for 4.0 and is not meant to be used
 * externally.  It needs to be public so that other packages
 * may use it.
 * 
 * @deprecated Silencing.
 */
@SuppressWarnings("deprecation") @Deprecated
class ClassificationHandlerCorpusAdapter<E> 
     ...
     */
    @SuppressWarnings("deprecation") @Deprecated
    public ClassificationHandlerCorpusAdapter(Corpus<com.aliasi.corpus.ClassificationHandler<E,Classification>> corpus) {
        mCorpus = corpus;
    }
