 ...
 * @version 3.9.1
 * @since   LingPipe2.1
 * @deprecated Use {@link ObjectHandler} with generic type {@link
 * com.aliasi.tag.Tagging} if no whitespace is involved
 * or {@link com.aliasi.tag.StringTagging} if whitespace is required.
 */
@Deprecated
